            ...
            content=ft.ResponsiveRow(
                ...
                controls=[
                    ft.Container(
                        ...
                        content=ft.Column(
                            controls=[
                                ft.Text(value='ANDERSON GABRIEL', theme_style=ft.TextThemeStyle.HEADLINE_LARGE),
                                ft.Text(
                                    spans=[
                                        ft.TextSpan(text='<'),
                    ...
                    ft.Container(
                        ...
                        content=ft.Image(
                            ...
                            width=15,
                            scale=ft.Scale(scale=0.8, alignment=ft.alignment.bottom_center)
                        )
                    )
                ]
            )
        ...
        testimonials = Carousel(
            controls=[
                TestimonialItem(
                    ...
                    testimonial= 'Desenvolvimento e interfaces inteligentes.',
                ),
                TestimonialItem(
                    user='Amanda', 
                    job= 'Personal', 
